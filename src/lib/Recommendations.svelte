<section id="street-cred" class="bg-bbuilds-yellow py-10 lg:py-20">
    <div class="container mx-auto px-4 text-center">
        ...
        <figure>
            ...
            <figcaption class="mt-4">— <cite><a  href="https://www.linkedin.com/in/branden-builds/" class="underline" title="Aisha's Reccomendation" target="_blank" rel="nofollow external">Aisha Frances Natividad</a></cite></figcaption>
        </figure>
    </div>
</section>